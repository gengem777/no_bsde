...
class DiffusionModelGenerator(BaseGenerator):
    ...
    def __getitem__(self, idx: int):
        ...
        x, dw, dw1, dw2 = self.sde.sde_simulation(params_batch_model, self.config.M)
        ...
        param = tf.concat([model_param, option_param], -1)
        ...
        data = t_pls, x_pls, t_now, x_now, x, dw, param, dw1, dw2
        return (data, y)
